...
export const ASSISTANTS: DocAssistant[] = [
 {
  "id": "govhealth.ghl-policy-interpret",
  "domain": "govhealth",
  "label": "健康政策解读稿",
  "shortLabel": "政策解读",
  "icon": "📑",
 ...
 {
  "id": "govhealth.ghl-public-health-service",
  "domain": "govhealth",
  "label": "基本公卫服务材料",
  "shortLabel": "公卫服务",
  "icon": "🏥",
 ...
 {
  "id": "govhealth.ghl-grassroots-clinic",
  "domain": "govhealth",
  "label": "基层卫生工作材料",
  "shortLabel": "基层卫生",
  "icon": "🩺",
 ...
 {
  "id": "govhealth.ghl-family-doctor",
  "domain": "govhealth",
  "label": "家庭医生签约说明",
  "shortLabel": "家医签约",
  "icon": "👨‍⚕️",
 ...
 {
  "id": "govhealth.ghl-infectious-prevention",
  "domain": "govhealth",
  "label": "传染病防控宣传",
  "shortLabel": "传防宣传",
  "icon": "🦠",
 ...
 {
  "id": "govhealth.ghl-maternal-child",
  "domain": "govhealth",
  "label": "妇幼健康材料",
  "shortLabel": "妇幼健康",
  "icon": "🤱",
 ...
 {
  "id": "govhealth.ghl-patriotic-hygiene",
  "domain": "govhealth",
  "label": "爱国卫生材料",
  "shortLabel": "爱卫材料",
  "icon": "🧹",
 ...
 {
  "id": "govhealth.ghl-medical-institution-mgmt",
  "domain": "govhealth",
  "label": "医疗机构管理材料",
  "shortLabel": "医政管理",
  "icon": "🏨",
 ...
 {
  "id": "govhealth.ghl-supervision-compliance",
  "domain": "govhealth",
  "label": "卫生监督合规提示",
  "shortLabel": "监督合规",
  "icon": "🔍",
 ...
 {
  "id": "govhealth.ghl-health-popsci",
  "domain": "govhealth",
  "label": "健康科普文案",
  "shortLabel": "健康科普",
  "icon": "📣",
 ...
 {
  "id": "govhealth.ghl-health-reform",
  "domain": "govhealth",
  "label": "医改工作材料",
  "shortLabel": "医改材料",
  "icon": "📊",
 ...
 {
  "id": "govhealth.ghl-work-briefing",
  "domain": "govhealth",
  "label": "卫健工作简报",
  "shortLabel": "工作简报",
  "icon": "🗞️",
 ...
 {
  "id": "govhealth.ghl-health-promotion-plan",
  "domain": "govhealth",
  "label": "健康促进活动方案",
  "shortLabel": "活动方案",
  "icon": "🎯",
 ...
 {
  "id": "govhealth.ghl-polish-normalize",
  "domain": "govhealth",
  "label": "卫健材料规范润色",
  "shortLabel": "规范润色",
  "icon": "🪶",
 ...
 {
  "id": "govhealth.ghl-record-extract",
  "domain": "govhealth",
  "label": "公卫信息抽取",
  "shortLabel": "信息抽取",
  "icon": "🗃️",
