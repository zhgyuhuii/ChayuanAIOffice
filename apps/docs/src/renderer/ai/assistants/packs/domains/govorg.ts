...
export const ASSISTANTS: DocAssistant[] = [
 {
  "id": "govorg.gor-party-building-draft",
  "domain": "govorg",
  "label": "基层党建工作材料起草",
  "shortLabel": "党建材料",
  "icon": "🚩",
 ...
 {
  "id": "govorg.gor-member-develop-draft",
  "domain": "govorg",
  "label": "党员发展材料起草",
  "shortLabel": "发展党员",
  "icon": "📝",
 ...
 {
  "id": "govorg.gor-cadre-inspect-frame",
  "domain": "govorg",
  "label": "干部考察材料框架",
  "shortLabel": "考察框架",
  "icon": "🗂️",
 ...
 {
  "id": "govorg.gor-talent-policy-draft",
  "domain": "govorg",
  "label": "人才政策材料起草",
  "shortLabel": "人才政策",
  "icon": "🧑‍🔬",
 ...
 {
  "id": "govorg.gor-reelection-draft",
  "domain": "govorg",
  "label": "党组织换届材料起草",
  "shortLabel": "换届材料",
  "icon": "🗳️",
 ...
 {
  "id": "govorg.gor-compliance-check",
  "domain": "govorg",
  "label": "组织工作合规提示",
  "shortLabel": "合规提示",
  "icon": "🔎",
 ...
 {
  "id": "govorg.gor-distance-edu-draft",
  "domain": "govorg",
  "label": "党员远程教育材料起草",
  "shortLabel": "远程教育",
  "icon": "📡",
 ...
 {
  "id": "govorg.gor-polish-normalize",
  "domain": "govorg",
  "label": "党务文稿规范化润色",
  "shortLabel": "规范润色",
  "icon": "✍️",
 ...
 {
  "id": "govorg.gor-apply-review-check",
  "domain": "govorg",
  "label": "入党材料文字审阅提示",
  "shortLabel": "入党审阅",
  "icon": "🪧",
 ...
 {
  "id": "govorg.gor-party-lecture-draft",
  "domain": "govorg",
  "label": "党课讲稿起草",
  "shortLabel": "党课讲稿",
  "icon": "🎤",
 ...
 {
  "id": "govorg.gor-civil-assign-draft",
  "domain": "govorg",
  "label": "公务员调配文稿起草",
  "shortLabel": "调配文稿",
  "icon": "🏛️",
