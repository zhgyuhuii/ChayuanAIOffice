...
export const ASSISTANTS: DocAssistant[] = [
 ...
 {
  "id": "ballsport.bs-coach-review-polish",
  "domain": "ballsport",
  "label": "教练点评润色",
  "shortLabel": "点评润色",
  "icon": "📝",
 ...
 {
  "id": "ballsport.bs-complaint-reply",
  "domain": "ballsport",
  "label": "客诉回复撰写",
  "shortLabel": "客诉回复",
  "icon": "🤝",
 ...
 {
  "id": "ballsport.bs-equipment-check",
  "domain": "ballsport",
  "label": "器材保养核查",
  "shortLabel": "器材核查",
  "icon": "🔧",
