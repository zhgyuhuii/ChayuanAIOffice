...
export const ASSISTANTS: DocAssistant[] = [
 ...
 {
  "id": "steel.sl-operation-procedure",
  "domain": "steel",
  "label": "操作规程框架",
  "shortLabel": "操作规程",
  "icon": "📋",
 ...
 {
  "id": "steel.sl-equip-fault-extract",
  "domain": "steel",
  "label": "设备故障信息提取",
  "shortLabel": "故障提取",
  "icon": "🔧",
