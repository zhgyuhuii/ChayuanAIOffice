...
export const ASSISTANTS: DocAssistant[] = [
 ...
 {
  "id": "textile.tx-inspection-report",
  "domain": "textile",
  "label": "质量检验报告整理",
  "shortLabel": "检验报告",
  "icon": "🔍",
 ...
 {
  "id": "textile.tx-qc-standard-check",
  "domain": "textile",
  "label": "品控标准核查",
  "shortLabel": "品控核查",
  "icon": "🛡️",
 ...
 {
  "id": "textile.tx-material-extract",
  "domain": "textile",
  "label": "面辅料用量提取",
  "shortLabel": "用料提取",
  "icon": "🧶",
