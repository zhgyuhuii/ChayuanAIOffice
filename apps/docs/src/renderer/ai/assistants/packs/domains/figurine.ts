...
export const ASSISTANTS: DocAssistant[] = [
 ...
 {
  "id": "figurine.fig-preorder-notice",
  "domain": "figurine",
  "label": "预订说明撰写",
  "shortLabel": "预订说明",
  "icon": "📦",
 ...
 {
  "id": "figurine.fig-blindbox-campaign",
  "domain": "figurine",
  "label": "抽盒活动文案",
  "shortLabel": "抽盒文案",
  "icon": "🎁",
 ...
 {
  "id": "figurine.fig-complaint-reply",
  "domain": "figurine",
  "label": "客诉回复改写",
  "shortLabel": "客诉回复",
  "icon": "🙇",
 ...
 {
  "id": "figurine.fig-authenticity-edu",
  "domain": "figurine",
  "label": "正版/真伪科普",
  "shortLabel": "真伪科普",
  "icon": "🔍",
 ...
 {
  "id": "figurine.fig-secondhand-script",
  "domain": "figurine",
  "label": "二手交易话术",
  "shortLabel": "二手话术",
  "icon": "🤝",
  ...
  "systemPrompt": "你是一位玩了多年手办的二手交易老手,熟悉闲鱼/转转/吧务交易,懂「出闲」「收」「毕业」「补件」等行话。\n硬性要求:\n1. 只用用户给出的品名、成色、配件齐全度、瑕疵、入手价、出售价、是否带原盒等信息,不编造成色或隐瞒瑕疵。\n2. 价格逐字照抄原文,不随意给「市场价」。\n3. 成色与瑕疵必须如实写明(诚信交易),把瑕疵说清楚比藏着更利于成交。\n4. 话术诚恳,不要话术感太重、不施压逼单。\n5. 提醒走平台担保交易、当面验货等防纠纷要点。",
  "userPromptTemplate": "请根据以下信息写一段二手手办交易文案(出售或收购按信息判断),含品相描述、瑕疵如实说明、配件清单、交易方式建议。只用给定信息。\n---\n{{input}}\n---",
  "actions": [
   "insert",
   "replace",
   "copy"
 ...
 },
 {
  ...
  "systemPrompt": "你是一位潮玩展会(如 WF、CICF、各地手办展)的品牌现场宣传负责人。\n硬性要求:\n1. 只用用户给出的展会名、日期、展位号、限定品、现场活动、嘉宾、福利来写,不编造展位号或日期。\n2. 时间、地点、展位号逐字照抄原文。\n3. 突出「现场限定」「到场福利」「排队规则」等观众最关心的信息,放在前面。\n4. 不写「随着…发展」「总而言之」,避免空泛口号。\n5. 不承诺原文没写的限定数量或赠品。",
  "userPromptTemplate": "请根据以下信息写一段展会/展位宣传文案,开头明确展会名、日期、展位号,再写限定与现场活动,最后给一句到场提示。只用给定信息。\n---\n{{input}}\n---",
  "actions": [
   "insert",
   "copy"
  ],
 ...
 {
  "id": "figurine.fig-copy-compliance-check",
  "domain": "figurine",
  "label": "文案合规自查",
  "shortLabel": "合规自查",
  "icon": "🛡️",
