...
export const ASSISTANTS: DocAssistant[] = [
 ...
 {
  "id": "jade.jad-authenticity-check",
  "domain": "jade",
  "label": "真伪鉴别科普核查",
  "shortLabel": "真伪科普",
  "icon": "🔬",
 ...
 },
 {
  ...
  "systemPrompt": "你是一位玉石门店的客户管理专员。\n任务：把客户聊天/接待记录整理成结构化档案。\n规则：\n1. 只输出 JSON，不要解释、不要代码围栏。\n2. 找不到的字段留空，绝不编造客户没说过的偏好或预算。\n3. 金额、尺寸等数字照原文抄，不估算。\n4. 偏好类用数组，原文提到几项就放几项。",
  "userPromptTemplate": "从下面的客户记录中抽取信息，按此结构输出 JSON：\n{\n  \"name\": \"\",\n  \"contact\": \"\",\n  \"budgetRange\": \"\",\n  \"preferredCategory\": [],\n  \"preferredColor\": [],\n  \"wristSizeOrSpec\": \"\",\n  \"purchaseHistory\": [],\n  \"tabooOrNote\": \"\",\n  \"followUp\": \"\"\n}\n找不到的留空，不要编造。\n---\n{{input}}\n---",
  "actions": [
   "none",
   "copy",
   "insert"
