...
export const ASSISTANTS: DocAssistant[] = [
 {
  "id": "govmedicare.gmi-canbao-jiaofei",
  "domain": "govmedicare",
  "label": "医保参保缴费指南起草",
  "shortLabel": "参保缴费",
  "icon": "🪪",
 ...
 {
  "id": "govmedicare.gmi-baoxiao-shuoming",
  "domain": "govmedicare",
  "label": "医保报销说明起草",
  "shortLabel": "报销说明",
  "icon": "🧾",
 ...
 {
  "id": "govmedicare.gmi-menzhen-tongchou",
  "domain": "govmedicare",
  "label": "门诊统筹政策解读",
  "shortLabel": "门诊统筹",
  "icon": "🏥",
 ...
 {
  "id": "govmedicare.gmi-jicai-jiedu",
  "domain": "govmedicare",
  "label": "集采政策解读",
  "shortLabel": "集采解读",
  "icon": "💊",
 ...
 {
  "id": "govmedicare.gmi-jijin-jianguan-tongbao",
  "domain": "govmedicare",
  "label": "医保基金监管通报框架",
  "shortLabel": "监管通报",
  "icon": "🛡️",
 ...
 {
  "id": "govmedicare.gmi-dingdian-guanli",
  "domain": "govmedicare",
  "label": "定点机构管理材料起草",
  "shortLabel": "定点管理",
  "icon": "🏷️",
 ...
 {
  "id": "govmedicare.gmi-jingban-fuwu-zhinan",
  "domain": "govmedicare",
  "label": "医保经办服务指南起草",
  "shortLabel": "经办指南",
  "icon": "🪟",
 ...
 {
  "id": "govmedicare.gmi-zhengce-xuanchuan",
  "domain": "govmedicare",
  "label": "医保政策宣传稿起草",
  "shortLabel": "政策宣传",
  "icon": "📣",
 ...
 {
  "id": "govmedicare.gmi-hegui-fanzha",
  "domain": "govmedicare",
  "label": "医保合规与欺诈防范核查",
  "shortLabel": "合规核查",
  "icon": "🔍",
 ...
 {
  "id": "govmedicare.gmi-shengyu-baoxian",
  "domain": "govmedicare",
  "label": "生育保险待遇说明起草",
  "shortLabel": "生育保险",
  "icon": "👶",
 ...
 {
  "id": "govmedicare.gmi-changhu-xian",
  "domain": "govmedicare",
  "label": "长护险政策材料起草",
  "shortLabel": "长护险",
  "icon": "🧑‍🦽",
 ...
 {
  "id": "govmedicare.gmi-gongzuo-zongjie",
  "domain": "govmedicare",
  "label": "医保工作总结起草",
  "shortLabel": "工作总结",
  "icon": "📑",
 ...
 {
  "id": "govmedicare.gmi-runse-guifan",
  "domain": "govmedicare",
  "label": "医保文稿规范化润色",
  "shortLabel": "规范润色",
  "icon": "✒️",
 ...
 {
  "id": "govmedicare.gmi-yaodian-jiansha",
  "domain": "govmedicare",
  "label": "政策文件要点抽取",
  "shortLabel": "要点抽取",
  "icon": "🗂️",
