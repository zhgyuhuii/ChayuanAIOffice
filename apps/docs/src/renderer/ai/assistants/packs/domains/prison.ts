...
export const ASSISTANTS: DocAssistant[] = [
 ...
 {
  "id": "prison.pri-compliance-check",
  "domain": "prison",
  "label": "合规与表述风险审查",
  "shortLabel": "合规审查",
  "icon": "🛡️",
