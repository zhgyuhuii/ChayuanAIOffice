...
export const ASSISTANTS: DocAssistant[] = [
 {
  "id": "govmarketreg.gmr-business-license-guide",
  "domain": "govmarketreg",
  "label": "营业执照办理指南",
  "shortLabel": "执照办理指南",
  "icon": "📇",
 ...
 {
  "id": "govmarketreg.gmr-food-safety",
  "domain": "govmarketreg",
  "label": "食品安全监管材料",
  "shortLabel": "食品安全材料",
  "icon": "🍚",
 ...
 {
  "id": "govmarketreg.gmr-special-equipment",
  "domain": "govmarketreg",
  "label": "特种设备安全材料",
  "shortLabel": "特设安全材料",
  "icon": "🛗",
 ...
 {
  "id": "govmarketreg.gmr-quality-sampling-report",
  "domain": "govmarketreg",
  "label": "产品质量抽检通报",
  "shortLabel": "抽检通报",
  "icon": "🔬",
 ...
 {
  "id": "govmarketreg.gmr-ad-compliance-check",
  "domain": "govmarketreg",
  "label": "广告合规核查",
  "shortLabel": "广告核查",
  "icon": "🚫",
 ...
 {
  "id": "govmarketreg.gmr-consumer-confidence",
  "domain": "govmarketreg",
  "label": "放心消费创建材料",
  "shortLabel": "放心消费",
  "icon": "🛒",
 ...
 {
  "id": "govmarketreg.gmr-self-employed-policy",
  "domain": "govmarketreg",
  "label": "个体工商户扶持解读",
  "shortLabel": "个体户扶持",
  "icon": "🏪",
 ...
 {
  "id": "govmarketreg.gmr-ip-protection",
  "domain": "govmarketreg",
  "label": "知识产权保护材料",
  "shortLabel": "知产保护",
  "icon": "®️",
 ...
 {
  "id": "govmarketreg.gmr-price-supervision",
  "domain": "govmarketreg",
  "label": "价格监管材料",
  "shortLabel": "价格监管",
  "icon": "🏷️",
 ...
 {
  "id": "govmarketreg.gmr-drug-device-cosmetics",
  "domain": "govmarketreg",
  "label": "药械化妆品监管材料",
  "shortLabel": "药械化妆品",
  "icon": "💊",
 ...
 {
  "id": "govmarketreg.gmr-market-entity-cultivation",
  "domain": "govmarketreg",
  "label": "市场主体培育材料",
  "shortLabel": "主体培育",
  "icon": "🌱",
 ...
 {
  "id": "govmarketreg.gmr-credit-supervision",
  "domain": "govmarketreg",
  "label": "企业信用监管材料",
  "shortLabel": "信用监管",
  "icon": "📊",
 ...
 {
  "id": "govmarketreg.gmr-double-random",
  "domain": "govmarketreg",
  "label": "双随机一公开材料",
  "shortLabel": "双随机",
  "icon": "🎲",
 ...
 {
  "id": "govmarketreg.gmr-complaint-handling",
  "domain": "govmarketreg",
  "label": "投诉举报处置材料",
  "shortLabel": "投诉举报处置",
  "icon": "📞",
 ...
 {
  "id": "govmarketreg.gmr-administrative-guidance",
  "domain": "govmarketreg",
  "label": "行政指导约谈材料",
  "shortLabel": "行政指导约谈",
  "icon": "🗣️",
 ...
 {
  "id": "govmarketreg.gmr-work-summary",
  "domain": "govmarketreg",
  "label": "市场监管工作总结",
  "shortLabel": "工作总结",
  "icon": "📅",
 ...
 {
  "id": "govmarketreg.gmr-doc-polish",
  "domain": "govmarketreg",
  "label": "公文规范化润色",
  "shortLabel": "公文润色",
  "icon": "✒️",
 ...
 {
  "id": "govmarketreg.gmr-entity-extract",
  "domain": "govmarketreg",
  "label": "市场主体信息抽取",
  "shortLabel": "主体信息抽取",
  "icon": "🗂️",
