...
export const ASSISTANTS: DocAssistant[] = [
 {
  "id": "govhotline.ght-worktick-reply",
  "domain": "govhotline",
  "label": "12345工单办理答复",
  "shortLabel": "工单答复",
  "icon": "☎️",
 ...
 {
  "id": "govhotline.ght-intake-classify",
  "domain": "govhotline",
  "label": "来电诉求分类整理",
  "shortLabel": "诉求分类",
  "icon": "🗂️",
 ...
 {
  "id": "govhotline.ght-followup-script",
  "domain": "govhotline",
  "label": "满意度回访话术",
  "shortLabel": "回访话术",
  "icon": "📞",
 ...
 {
  "id": "govhotline.ght-supervise-notice",
  "domain": "govhotline",
  "label": "督办催办材料",
  "shortLabel": "督办催办",
  "icon": "⏰",
 ...
 {
  "id": "govhotline.ght-return-reason",
  "domain": "govhotline",
  "label": "工单退回理由说明",
  "shortLabel": "退回说明",
  "icon": "↩️",
 ...
 {
  "id": "govhotline.ght-reply-compliance-check",
  "domain": "govhotline",
  "label": "答复规范性核查",
  "shortLabel": "答复核查",
  "icon": "🔍",
 ...
 {
  "id": "govhotline.ght-reply-polish",
  "domain": "govhotline",
  "label": "答复文稿规范化润色",
  "shortLabel": "答复润色",
  "icon": "✍️",
 ...
 {
  "id": "govhotline.ght-worktick-extract",
  "domain": "govhotline",
  "label": "工单要素抽取",
  "shortLabel": "工单抽取",
  "icon": "🔎",
 ...
 {
  "id": "govhotline.ght-praise-suggestion",
  "domain": "govhotline",
  "label": "表扬建议处理",
  "shortLabel": "表扬建议",
  "icon": "🌟",
 ...
 {
  "id": "govhotline.ght-sensitive-handling",
  "domain": "govhotline",
  "label": "敏感诉求处置材料",
  "shortLabel": "敏感处置",
  "icon": "⚠️",
 ...
 {
  "id": "govhotline.ght-work-summary",
  "domain": "govhotline",
  "label": "热线工作总结",
  "shortLabel": "工作总结",
  "icon": "📋",
 ...
 {
  "id": "govhotline.ght-service-standard",
  "domain": "govhotline",
  "label": "热线服务规范",
  "shortLabel": "服务规范",
  "icon": "📐",
 ...
 {
  "id": "govhotline.ght-satisfaction-analysis",
  "domain": "govhotline",
  "label": "群众满意度分析",
  "shortLabel": "满意度分析",
  "icon": "📈",
 ...
 {
  "id": "govhotline.ght-policy-explain",
  "domain": "govhotline",
  "label": "政策解读问答",
  "shortLabel": "政策解读",
  "icon": "📘",
