...
export function Ribbon({
  ...
  showThumbs,
  onToggleThumbs,
  // LOCAL(2026-09-22, f5247d3..476e5023): multi-conversation AiPanel props replace upstream's single aiOpen/onToggleAi pair; onInsert dropped per upstream
  aiPanelAvailable,
  aiPanelOpen,
  onToggleAiPanel,
  onAiPreset,
          ...
          <>
            ...
            <Group label={t('ribbonGroupAnimation')}>
              <div className="rb-gallery">
                ...
                {ANIM_EFFECTS.filter((a) => a.cls !== 'media' || selectionIsMedia).map((a) => (
                  <button
                    key={a.kind}
