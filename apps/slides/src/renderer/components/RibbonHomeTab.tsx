...
import { ColorPicker, isSymbolFontFamily } from '@chatoffice/ui'
...
export function RibbonHomeTab({ rb }: { rb: RibbonTabCtx }) {
  ...
  return (
    <>
      ...
      {/* CT_Home.kuip(wpp) RB_SlideShow = KQuickMenuCommand：主钮“当页开始”
          + caret 菜单（从头开始/当页开始），与 WPS 开始页一致 */}
      ...
      <div className="ribbon-sep" />
      {/* WPS 对齐：幻灯片组常驻展开为三个按钮（新建幻灯片⌄ / 版式⌄ / 节），
          不再写死折叠进一个下拉按钮；窄窗口交由 ribbon 横向滚动兜底 */}
