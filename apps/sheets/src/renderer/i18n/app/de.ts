...
export const de = {
  ...
  appCvtToValue: 'In Zahl konvertieren',
  appCvtToText: 'In Text konvertieren',
  appCvtToDate: 'In Datum',
  appCvtToUpper: 'In Großbuchstaben',
  appCvtToCnUpper: 'In chinesische Großschreibung',
  appCvtToFraction: 'In Bruch',
  appCvtSubSupHead: 'Hoch-/Tiefstellung',
  appCvtSup: 'Hochstellung',
  appCvtSub: 'Tiefstellung',
  appCvtCustom: 'Benutzerdefinierte Konvertierung',
