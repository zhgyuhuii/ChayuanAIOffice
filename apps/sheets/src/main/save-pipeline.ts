/**
 * Workbook save orchestration shared by the Electron main and the web BFF
 * (plan v2.2 batch 3 stage 2): resolves renderer edits/sheet ops against the
 * session map and composes the sidecar streaming save. No Electron imports.
 */
...
export async function saveWorkbookPlan(
