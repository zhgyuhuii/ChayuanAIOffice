...
const DROPDOWN_COMPONENT_KEY = 'chatoffice-active-data-validation-dropdown'
const INPUT_MESSAGE_COMPONENT_KEY = 'chatoffice-active-data-validation-input-message'
