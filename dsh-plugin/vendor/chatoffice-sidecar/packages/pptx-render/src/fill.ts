 ...
 */
import type { Fill, Stroke, ShadowEffect } from '@chatoffice/pptx-engine'
...
export function resolveGlow(
  glow: import('@chatoffice/pptx-engine').GlowEffect | undefined,
  vp: Viewport,
...
export function resolveReflection(
  reflection: import('@chatoffice/pptx-engine').ReflectionEffect | undefined,
  vp: Viewport,
