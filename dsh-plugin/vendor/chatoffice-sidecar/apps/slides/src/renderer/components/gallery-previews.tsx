 ...
 * is shared across apps via @chatoffice/ui (re-exported here for existing
...
export { ShapePreview, shapePreviewBox, shapePreviewPath } from '@chatoffice/ui/shape-gallery'
